...
public class DeflaterInputStream extends FilterInputStream {
    ...
    public DeflaterInputStream(InputStream in) {
        this(in, new java.util.zip.Deflater());
     ...
     */
    public DeflaterInputStream(InputStream in, java.util.zip.Deflater defl) {
        this(in, defl, 512);
    }
     ...
     * @throws NullPointerException if {@code in} or {@code defl} is null
     */
    public DeflaterInputStream(InputStream in, java.util.zip.Deflater defl, int bufLen) {
        super(in);
