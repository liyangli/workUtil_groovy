...
public class InflaterOutputStream extends FilterOutputStream {
    ...
    public InflaterOutputStream(OutputStream out) {
        this(out, new java.util.zip.Inflater());
     ...
     */
    public InflaterOutputStream(OutputStream out, java.util.zip.Inflater infl) {
        this(out, infl, 512);
    }
     ...
     * @throws NullPointerException if {@code out} or {@code infl} is null
     */
    public InflaterOutputStream(OutputStream out, java.util.zip.Inflater infl, int bufLen) {
        super(out);
